...
export const metadata: Metadata = {
  title: 'All Cancellation Guides',
  description: 'Browse step-by-step cancellation guides for every major subscription service.',
}
...
export default function CancelIndexPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12">
      <div className="mb-10">
        <p className="text-sm font-semibold text-blue-600 uppercase tracking-widest mb-2">All guides</p>
        <h1 className="text-3xl font-extrabold text-gray-900 mb-3">How to cancel any subscription</h1>
        <p className="text-gray-500">
          {allGuides.length} services covered · Sorted by cancellation difficulty (hardest first)
        </p>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
        <div className="grid grid-cols-[1fr_auto_auto] sm:grid-cols-[2fr_1fr_1fr_auto] gap-4 px-5 py-3 bg-gray-50 border-b border-gray-200 text-xs font-semibold text-gray-500 uppercase tracking-wide">
          ...
          <span className="hidden sm:block">Dark patterns</span>
          <span />
        </div>
