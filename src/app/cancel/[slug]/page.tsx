...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      title: `How to Cancel ${guide.service} — CancelKit`,
      description: guide.description,
    },
  }
}
...
export default function GuidePage({ params }: { params: { slug: string } }) {
  ...
  // HowTo JSON-LD schema (uses steps from first/web platform)
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <nav className="flex items-center gap-2 text-sm text-gray-400 mb-6">
          ...
          <span>/</span>
          <Link href="/cancel" className="hover:text-gray-600 transition-colors">Guides</Link>
          <span>/</span>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-5 mb-6">
          <div className="flex items-center justify-between gap-4 flex-wrap">
            <div>
              <p className="text-sm font-semibold text-gray-900 mb-1">Cancellation friction</p>
        ...
        {guide.refundPolicy && (
          <div className="bg-amber-50 border border-amber-200 rounded-2xl p-4 mb-6 flex gap-3">
            ...
            <div>
              <p className="text-sm font-semibold text-amber-900 mb-0.5">Refund policy</p>
        ...
        {/* Steps */}
        <div className="bg-white rounded-2xl border border-gray-200 p-6 mb-6">
          <h2 className="text-lg font-bold text-gray-900 mb-5">Step-by-step instructions</h2>
        ...
        {guide.alternatives && guide.alternatives.length > 0 && (
          <div className="bg-white rounded-2xl border border-gray-200 p-6 mb-6">
            <h2 className="text-lg font-bold text-gray-900 mb-4">
              Looking for alternatives to {guide.service}?
            </h2>
        ...
        <div className="flex items-center justify-between flex-wrap gap-4">
          ...
          <p className="text-xs text-gray-400">
            Steps changed?{' '}
            <a href="mailto:hello@cancelkit.com" className="underline hover:text-gray-600">
              Let us know
            </a>
          </p>
        </div>
